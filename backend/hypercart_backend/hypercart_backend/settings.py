"""
Django settings for hypercart_backend project.
...
#uncommnet below two lines if local stoarge is using
# MEDIA_URL='/media/'
...
ROOT_URLCONF = 'hypercart_backend.urls'
...
WSGI_APPLICATION = 'hypercart_backend.wsgi.application'
